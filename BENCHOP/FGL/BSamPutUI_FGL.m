...
function [U,XXP,TT]=BSamPutUI_FGL(S,K,T,r,sigma)
% function [U,XXP,TTP]=BSamPutUI_FGL(S,K,T,r,sigma);
%
% ----------input---------------------------
%
...
[y]=binsearch(f,0.95*ylast,ylast,1e-6,k,n);
XXP(n+1-k+1)=exp(y);
