...
function [U]=AmDDRBFPU1D(S,K,T,r,sig,payoff,phi,ep,xc,M,np,op,D,alpha)
% Compute the value of an American option with discrete dividends
...
% alpha time when dividends are paid out 
%
