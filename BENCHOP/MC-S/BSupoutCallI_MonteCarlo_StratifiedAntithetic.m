...
% Reference: Conditioning on one-step survival for barrier option
% simulations
% 

function [U]=BSupoutCallI_MonteCarlo_StratifiedAntithetic(Sin,K,T,r,sigma,B)
...
U(si) = exp(-r*T).*Val/N;   
%test:
%tic,BSupoutCallI_MonteCarlo_StratifiedAntithetic(90,100,1,0.03,0.15,125),toc
