...
function [U,errRel]=BSeuCallUII_CMT(S,K,T,r,sigma)
S=S(:)';
...
% P0_BS=BSCall_exact(S0,K0,T,r,par);
% errRel=(P0-P0_BS)./P0_BS

% % Plot solution
% SGrid=60:1:160;
% plot(SGrid,F(SGrid),SGrid,BSCall_exact(SGrid,K0,T,r,par),'--');
